import { x as withLeadingSlash, q as joinURL, y as withoutTrailingSlash, O as withBase, A as hash } from '../_/nitro.mjs';
import { b as useRuntimeConfig } from './server.mjs';
import { a as useRequestEvent } from './ssr-BSj2qKRT.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-D7nzEkQL.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-BRkho5Tl.mjs.map
